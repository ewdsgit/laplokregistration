<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="LaplokPasswordRecovery.signup" %>
...
<section class="position-relative h-100 pt-5 pb-4">
    ...
    <div class="container d-flex flex-wrap justify-content-center justify-content-xl-start h-100 pt-5">
      <div class="w-100 align-self-end pt-1 pt-md-4 pb-4" style="max-width: 526px;">
        ...
        <p class="text-center text-xl-start pb-3 mb-3">Already have an account? <a href="/default">Sign in here.</a></p>
    ...
    <!-- Background -->
    <div class="position-absolute top-0 end-0 w-50 h-100 bg-position-center bg-repeat-0 bg-size-cover d-none d-xl-block" style="background-image: url(assets/img/account/signup-bg.png);"></div>
  </section>
</asp:Content>
